...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new Building("Hatfield Hall", "Neilson Drive Northampton, MA 01063", 2));
        myMap.addBuilding(new Building("Sabin-Reed Hall", "44 College Lane Northampton, MA 01063", 3));
        myMap.addBuilding(new Building("Burton Hall", "44 College Lane Northampton, MA 01063", 3));
        myMap.addBuilding(new Building("McConnell Hall", "2 Tyler Court Northampton, MA 01063", 4));
        myMap.addBuilding(new Building("Alumni Gym", "83 Green Street Northampton, MA 01063", 3));
        ...
        myMap.addBuilding(new Building("John M. Green Hall", "60 Elm Street Northampton, MA 01063", 2));
